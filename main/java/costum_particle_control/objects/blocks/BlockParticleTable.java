...
import costum_particle_control.objects.tileentity.TileEntityParticleTable;
...
public class BlockParticleTable extends Block implements IHasModel
{
	public BlockParticleTable(String name, Material material) 
	{
		super(material);
	...
	{
		return new TileEntityParticleTable(world);
	}	
